...
let productos = Number(prompt("Ingrese que producto necesitas comprar \n1-agarre perro \n2-buzo perro \n3-chaleco gato \n4-chaleco perro \n5-remera Argentina \n6-bandana perro \n7-campera disney \n8-vestido calabaza perro"));
...
alert("nombre: " + seleccionProductos(productosShop,productos).nombre + ", Precio: " + seleccionProductos(productosShop,productos).precio);
...
alert("usted va a recibir el " + calcularDescuento(cantidadProductos) + "% de descuento")
...
alert("usted debe abonar $" + calcularTotal(productos,cantidadProductos, productosShop));

// const productosShop2 = [{
//     id: 9,
//     picture: "./imagenes/vestidoCalabazaPerro.webp",
//     nombre: "casco calabaza perro",
//     text: "casco calabaza para perros, solo para estatura grande",
//     precio: "$1700"
// }]


// const productosFinal = productosShop.concat(productosShop2);
